	...
	*removeAll {
	...
	init {|isPipeArg|
		...
		if(isPipe.not, {
			...
			"OscPipe: pipe functionality is not yet thoroughly tested, use at your own risk".warn;
...
///this WORKS!!!!!!!!!!
// ping google.com | ruby -e '$stdin.each_line do |l|; print "/address \""; print l.gsub(/\n/, ""); puts "\""; $stdout.flush; end'
